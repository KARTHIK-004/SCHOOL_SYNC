...
const schoolAdminNavigation = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Create Class", url: "/dashboard/academics/classes/create" },
      { title: "Sections", url: "/dashboard/academics/sections" },
      { title: "Create Section", url: "/dashboard/academics/sections/create" },
...
export const navigationData = {
  // Make schoolAdmin the first option and use as default
  schoolAdmin: {
...
export const defaultNavigation = navigationData.schoolAdmin;
